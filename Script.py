...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>✯ Mʏ Nᴀᴍᴇ ⋟ {}
➢ Cʀᴇᴀᴛᴏʀ ⋟ <a href='https://t.me/DTupdatez'>𝚂α𝙷α𝚁α𝙽 ᠰ 𝚂αα𐌱</a>
...
- ꜱᴏᴜʀᴄᴇ - <a href="https://github.com/OfficialDanav">ʜᴇʀᴇ</a>
Dᴇᴠᴇʟᴏᴘᴇʀ:
- <a href="https://t.me/SAHARAN_09">𝚂α𝙷α𝚁α𝙽 ᠰ 𝚂αα𐌱</a></b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/DTupdatez)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
• /deletefiles - <code>Tᴏ ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD Fɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    STATUS_TXT = """<b>★ Tᴏᴛᴀʟ Fɪʟᴇs: <code>786{}</code>
★ Tᴏᴛᴀʟ Usᴇʀs: <code>16{}</code>
★ Tᴏᴛᴀʟ Cʜᴀᴛs: <code>10{}</code>
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MELCOW_ENG = """<b>Hᴇʟʟᴏ {} 😍, \n Wᴇʟᴄᴏᴍᴇ Tᴏ {} Gʀᴏᴜᴘ 🧡🤍💚,\n\nSᴇɴᴅ Yᴏᴜʀ Fᴀᴠᴏʀɪᴛᴇ Mᴏᴠɪᴇ ᴏʀ Sᴇʀɪᴇs Nᴀᴍᴇ🤗,\nI'ʟʟ Tʀʏ 𝜏ᴏ Fɪɴᴅ 𐌱ᴇsᴛ Rᴇsᴜʟᴛs Fᴏʀ Yᴏᴜ💁.</b>"""

    OWNER_INFO = """
<b>⍟───[ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ ]───⍟
    
• ꜰᴜʟʟ ɴᴀᴍᴇ : 𝚂α𝙷α𝚁α𝙽 ᠰ 𝚂αα𐌱
• ᴜꜱᴇʀɴᴀᴍᴇ : @SAHARAN_09
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/SAHARAN_09'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
<b>Hᴇʏ {}, \nTʜᴇsᴇ ᴀʀᴇ ᴍʏ ᴛʜʀᴇᴇ ᴛʏᴘᴇs ᴏғ ғɪʟᴛᴇʀs.</b>"""
    ...
    GFILTER_TXT = """
<b>Wᴇʟᴄᴏᴍᴇ ᴛᴏ Gʟᴏʙᴀʟ Fɪʟᴛᴇʀs. \nGʟᴏʙᴀʟ Fɪʟᴛᴇʀs ᴀʀᴇ ᴛʜᴇ ғɪʟᴛᴇʀs sᴇᴛ ʙʏ ʙᴏᴛ ᴀᴅᴍɪɴs ᴡʜɪᴄʜ ᴡɪʟʟ ᴡᴏʀᴋ ᴏɴ ᴀʟʟ ɢʀᴏᴜᴘs.</b>
...
🛠️ 𐌱ᴜɪʟᴅ S𝜏α𝜏ᥙട ⋟ <code>v2.7.1 [ ട𝜏α𐌱ʟᴇ ]</code></b>"""
